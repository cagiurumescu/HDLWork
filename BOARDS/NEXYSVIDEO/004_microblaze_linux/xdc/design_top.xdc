...
## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { sysclock }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
create_clock -add -name sysclk_pin -period 10.000 -waveform {0 5.000} [get_ports {sysclock}];
