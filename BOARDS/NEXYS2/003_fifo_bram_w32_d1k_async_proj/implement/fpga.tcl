# 
# Project automation script for fpga 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source fpga.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../../../../common/rtl/counter_cdc.v"
   xfile add "../../../../common/rtl/fifo_bram_w32_d1k_async.v"
   xfile add "../../coregen/bram_sdp_w32_d1k_noreg/bram_sdp_w32_d1k_noreg.ngc"
   xfile add "../../coregen/bram_sdp_w32_d1k_noreg/bram_sdp_w32_d1k_noreg.v"
   xfile add "../../coregen/chipscope_icon_ctrl0/chipscope_icon_ctlr0.ngc"
   xfile add "../../coregen/chipscope_icon_ctrl0/chipscope_icon_ctlr0.v"
   xfile add "../../coregen/chipscope_ila_trig0/chipscope_ila_trig0.ngc"
   xfile add "../../coregen/chipscope_ila_trig0/chipscope_ila_trig0.v"
   xfile add "../constr/fpga.ucf"
   xfile add "../src/fpga.v"

   # Set the Top Module as well...
   project set top "fpga"
